...
import br.com.atlas.atlas.config.Messages;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ExceptionTranslator(Environment env, Messages messages) {
        this.env = env;
    ...
    public ResponseEntity<Problem> handleBusinessException(BusinessException ex, NativeWebRequest request) {
        ...
        BusinessProblem problem = BusinessProblem.builder().code(ex.getValue()).message(error).status(ex.getStatus()).detail(error).build();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "br.com.atlas");
    }
}
